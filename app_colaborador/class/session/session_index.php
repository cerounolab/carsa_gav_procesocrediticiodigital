<?php
    ...
    if ($resultJSON['code'] === 200) {
        ...
        $_SESSION['login_cargo_nombre']             = trim(strtoupper(strtolower($resultJSON['data']['login_cargo_nombre'])));
        $_SESSION['login_gerencia_codigo']          = intval($resultJSON['data']['login_gerencia_codigo']);
        $_SESSION['login_gerencia_nombre']          = trim(strtoupper(strtolower($resultJSON['data']['login_gerencia_nombre'])));
        $_SESSION['login_departamento_codigo']      = intval($resultJSON['data']['login_departamento_codigo']);
        $_SESSION['login_departamento_nombre']      = trim(strtoupper(strtolower($resultJSON['data']['login_departamento_nombre'])));
        ...
        $_SESSION['login_supervision_nombre']       = trim(strtoupper(strtolower($resultJSON['data']['login_supervision_nombre'])));
        $_SESSION['login_foto']                     = trim(strtoupper(strtolower($resultJSON['data']['login_foto'])));
        $_SESSION['login_email']                    = trim(strtolower($resultJSON['data']['login_email']));
