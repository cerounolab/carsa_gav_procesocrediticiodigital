<?php
    ...
    function getTitleDominio($var01){
        ...
        switch ($var01) {
            ...
            case 'ADMEMPRESARUBRO':
                $result = 'Empresa Rubro';
                $grupoDom   = '';
                $grupoParm  = 0;
                break;

            case 'ADMEMPRESAACCESO':
                $result = 'Empresa Acceso';
                $grupoDom   = '';
                $grupoParm  = 0;
                break;

            case 'ADMSUCURSALESTADO':
                $result = 'Sucursal Estado';
                $grupoDom   = '';
                $grupoParm  = 0;
                break;

            case 'ADMSUCURSALTIPO':
                $result = 'Sucursal Tipo';
                $grupoDom   = '';
                $grupoParm  = 0;
                break;
        ...
        return array($result, $grupoDom, $grupoParm, $grupoSelect);
    }
?>