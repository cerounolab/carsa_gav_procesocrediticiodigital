...
function setRolFormulario(codRol, codForm, codAcc) {
	...
	if (codAcc == 1) {
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var07">Acceso DSP</label>'+
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var08">Acceso UPD</label>'+
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var09">Acceso DLT</label>'+
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var010">Acceso INS</label>'+
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var011">Acceso XLS</label>'+
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var012">Acceso PDF</label>'+
		...
		'									<div class="col-sm-12 col-md-4">'+
		'       					            <div class="form-group">'+
		'       					                <label for="var013">Acceso IMP</label>'+
