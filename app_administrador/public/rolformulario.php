<?php
	...
	$pageTitle		= 'Rol Formulario';
	$pageTitleNav	= '';
	$NavTitle		= 'Rol Formulario';
?>
<!DOCTYPE html>
<html lang="es">
	<head>
...
<?php
    if ($priv_insert === 'S'){
?>
												<a class="btn btn-info" style="background-color:#163562; border-color:#163562;" role="button" onclick="setRolFormulario(0, 0, 1);" data-bs-toggle="modal" data-bs-target="#modal-dialog" title="Nuevo" aria-hidden="true"><i class="ti-plus"></i> AGREGAR</a>
<?php
    }
?>
											</h4>
