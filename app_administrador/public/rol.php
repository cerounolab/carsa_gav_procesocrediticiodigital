									...
									<div class="box-body">
										<div class="row">
											...
											<h4 class="col-2 card-title" style="text-align: right;">
												<a class="btn btn-info" style="background-color:#163562; border-color:#163562;" role="button" onclick="setRol(0, 1);" data-bs-toggle="modal" data-bs-target="#modal-dialog" title="Nuevo" aria-hidden="true"><i class="ti-plus"></i> AGREGAR</a>
											</h4>
										</div><br>
									</div>
									<div class="col-xl-12 col-12">
...
?>
		...
		<script>
			const _parm04BASE = 'public/rol.php?';
		</script>

		<script src="./../js/api.js?<?php echo date('Ymd');?>"></script>
		<script src="./../js/rol.js?<?php echo date('Ymd');?>"></script>
