<?php
	...
	$pageTitle		= 'Usuario Rol';
	$pageTitleNav	= '';
	$NavTitle		= 'Usuario Rol';
?>
<!DOCTYPE html>
<html lang="es">
	<head>
...
<?php
    if ($priv_insert === 'S'){
?>
												<a class="btn btn-info" style="background-color:#163562; border-color:#163562;" role="button" onclick="setUsuarioRol(0, 0, 0, 1);" data-bs-toggle="modal" data-bs-target="#modal-dialog" title="Nuevo" aria-hidden="true"><i class="ti-plus"></i> AGREGAR</a>
<?php
    }
?>
											</h4>
...
?>
		...
		<script>
			...
			const _parm04BASE		= 'public/usuariorol.php?';
			const _parm05BASE   	= '<?php echo trim($usu_05); ?>';
            const _parm06BASE   	= <?php echo trim($usu_06); ?>;
		</script>
		
		<script src="./../js/usuariorol.js?<?php echo date('Ymd');?>"></script>
	</body>
</html>