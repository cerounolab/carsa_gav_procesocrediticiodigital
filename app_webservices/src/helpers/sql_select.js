    ...
    switch (actionType) {
        ...
        case 2:
            query00 = `SELECT TOP 1 
                            ...
                            TRIM(a.AWPRETEL1+''+a.AWTEL1)       AS  persona_datoparticular_telefono1,
                            ...
                            TRIM(a.AWPRETEL2+''+a.AWTEL2)       AS  persona_datoparticular_telefono2,
                            ...
                            TRIM(a.AWPRETELF+''+a.AWTELFLIAR)   AS  persona_datoparticular_telefonofamiliar,  
                            ...
                            TRIM(a.AWBIPP+''+a.AWCELU)          As  persona_datoparticular_celular1,
                            ...
                            TRIM(a.AWBIPP1+''+a.AWCELU1)        AS  persona_datoparticular_celular2,
                            ...
                            TRIM(a.AWBIPP2+''+a.AWCELU1)        AS  persona_datoparticular_celular3,
        ...
        case 3:
            query00 = `SELECT TOP 1
                            ...
                            TRIM(a.AAEMPR)                  AS  persona_datolaboral_empresa,
                            ...
                            TRIM(a.BAHORD)                  AS  persona_datolaboral_hora_desde,
                            TRIM(a.BAHORA)                  AS  persona_datolaboral_hora_hasta,
                            a.BAFCHCOB                      AS  persona_datolaboral_diacobro,
                            TRIM(a.BALUN)                   AS  persona_datolaboral_dialunes,
                            TRIM(a.BAMAR)                   AS  persona_datolaboral_diamartes,
                            TRIM(a.BAMIE)                   AS  persona_datolaboral_diamiercoles,
                            TRIM(a.BAJUE)                   AS  persona_datolaboral_diajueves,
                            TRIM(a.BAVIE)                   AS  persona_datolaboral_diaviernes,
                            TRIM(a.BASAB)                   AS  persona_datolaboral_diasabado,
                            TRIM(a.BADOM)                   AS  persona_datolaboral_diadomingo,
                            a.BAINT                         AS  persona_datolaboral_interno,

                            TRIM(a.BAPRETEL1+''+a.BATEL1)   AS  persona_datolaboral_telefono1,                
                            a.BAESTTEL1						AS  persona_datolaboral_telefono1_estado,
                            TRIM(a.BAPRETEL1)               AS  persona_datolaboral_telefono1_prefijo,
                            TRIM(a.BATEL1)                  AS  persona_datolaboral_telefono1_numero,

                            TRIM(a.BAPRETEL2+''+a.BATEL2)   AS  persona_datolaboral_telefono2,
                            a.BAESTTEL2                     AS  persona_datolaboral_telefono2_estado,
                            TRIM(a.BAPRETEL2)               AS  persona_datolaboral_telefono2_prefijo,
                            TRIM(a.BATEL2)                  AS  persona_datolaboral_telefono2_numero,

                            TRIM(a.BAPRETEL3+''+a.BATEL3)   AS  persona_datolaboral_telefono3,
                            a.BAESTTEL3                     AS  persona_datolaboral_telefono3_estado,
                            TRIM(a.BAPRETEL3)               AS  persona_datolaboral_telefono3_prefijo,
                            TRIM(a.BATEL3)                  AS  persona_datolaboral_telefono3_numero,

                            TRIM(a.BAUSUALT)                AS  alta_usuario,
                            a.BAHRAALT                      AS  alta_fecha,
                            a.BAFCHALT						AS  alta_hora,

                            TRIM(a.BAUSUM)                  AS  auditoria_usuario,
                            TRIM(a.BAHRAM)                  AS  auditoria_fecha,
                            a.BAFCHM						AS  auditoria_hora,

                            b.AACUEN                        AS  persona_cuenta,

                            c.AJBARR		                AS  localidad_barrio_codigo,
                            TRIM(c.AJNOMB)	                AS  localidad_barrio_nombre,

                            d.APCIUD		                AS  localidad_ciudad_codigo,
                            TRIM(d.APNOMB)	                AS  localidad_ciudad_nombre,

                            e.AIDEPT		                AS  localidad_departamento_codigo,
                            TRIM(e.AINOMB)	                AS  localidad_departamento_nombre,

                            f.BDEMPCO                       AS  empresa_codigo,
                            f.BDEMPCO		                AS  empresa_codigo,	
                            TRIM(f.BDNOMBE)					AS  empresa_nombre,	
                            f.CSVAL23						AS  empresa_valor,
                            TRIM(f.BDRUC)					AS  empresa_ruc, 

                            g.AMCARG                        AS  cargo_codigo,
                            g.AMANTCOD		                AS  cargo_codigo_anterior,
                            TRIM(g.AMNOMB)					AS  cargo_nombre,
                            g.CSVAL4		                AS  cargo_valor,

                            h.CLIAREACOD                    AS  actividad_codigo,
                            TRIM(h.CLIAREADES)				AS  actividad_nombre,	
                            TRIM(h.CLIAREAOBS)              AS  actividad_observacion,

                            i.PROFCOD                       AS  profesion_codigo,
                            TRIM(i.PROFDES)	                AS  profesion_nombre,

                            j.ARCOD                         AS  area_codigo,
                            TRIM(j.ARDESC)					AS  area_nombre,
                            TRIM(j.AROBS)					AS  area_observacion,

                            k.F24CODFOR                     AS  forma_pago_codigo,
                            TRIM(k.F24DESCRIP)              AS  forma_pago_nombre,

                            l.ARENTE                        AS  banco_codigo,
                            TRIM(l.ARNOMB)	                AS  banco_nombre,
                            TRIM(l.ARREDU)	                AS  banco_abreviatura,
