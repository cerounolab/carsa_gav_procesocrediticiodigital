...
const getUsuarioFlujoRolSubEmpresa  = (apiREQ, apiRES) => {
    let _code       = 200;
    let _dataJSON   = [];
    let _codigo     = parseInt(apiREQ.params.rolsubordinado);
    let _codigo2    = parseInt(apiREQ.params.empresa);
...
const getUsuarioFlujoRolSupEmpresa  = (apiREQ, apiRES) => {
    let _code       = 200;
    let _dataJSON   = [];
    let _codigo     = parseInt(apiREQ.params.rolsuperior);
    let _codigo2    = parseInt(apiREQ.params.empresa);
    ...
    if (_USUFLUUSC && _USUFLUUS1 && _USUFLUROC && _USUFLURO1 && _USUFLUEMC && _USUFLUEST &&  _USUFLUCEM && _USUFLUCUS && _USUFLUCIP && _USUFLUCPR && _USUFLUAEM && _USUFLUAUS && _USUFLUAIP && _USUFLUAPR){
            (async () => {
                ...
                if (_code == 200) {
                    ...
                    xJSON   = xDATA[1];
                    xJSON   = await jsonBody(_code, 'Error', 'postUsuarioFlujo', 'El registro ya existe', null, 0, 0, 0, 0, xJSON);
                }else{
                    xJSON   = xDATA[1];
        ...
        (async () => {
            _code   = 400;
            xJSON   = await jsonBody(_code, 'Error', 'postUsuarioFlujo', 'Error: Verifique algún campo esta vacío', null, 0, 0, 0, 0, []);
            xJSON   = camelcaseKeys(xJSON, {deep: true});
    ...
    if (_USUFLUUSC && _USUFLUUS1 && _USUFLUROC && _USUFLURO1 && _USUFLUEMC && _USUFLUEST &&  _USUFLUCEM && _USUFLUCUS && _USUFLUCIP && _USUFLUCPR && _USUFLUAEM && _USUFLUAUS && _USUFLUAIP && _USUFLUAPR){
        (async () => {
            ...
            if (_code == 200) {
                ...
                xJSON   = xDATA[1];
                xJSON   = await jsonBody(_code, 'Error', 'putUsuarioFlujo', 'Error: El registro ya existe', null, 0, 0, 0, 0, xJSON);
            }else{
                xJSON   = xDATA[1];
                xJSON   = await jsonBody(_code, 'Error', xJSON.reference, null, xJSON.message, 0, 0, 0, 0, []);
            }
        ...
        (async () => {
            _code   = 400;
            xJSON   = await jsonBody(_code, 'Error', 'putUsuarioFlujo', 'Error: Verifique algún campo esta vacío', null, 0, 0, 0, 0, []);
            xJSON   = camelcaseKeys(xJSON, {deep: true});
            return apiRES.status(200).json(xJSON);
        })();
...
const deleteUsuarioFlujo= (apiREQ, apiRES) => {
    ...
    if (_USUFLUUSC && _USUFLUUS1 && _USUFLUROC && _USUFLURO1 && _USUFLUEMC && _USUFLUEST &&  _USUFLUCEM && _USUFLUCUS && _USUFLUCIP && _USUFLUCPR && _USUFLUAEM && _USUFLUAUS && _USUFLUAIP && _USUFLUAPR){
        ...
        (async () => {
            _code   = 400;
            xJSON   = await jsonBody(_code, 'Error', 'deleteUsuarioFlujo', 'Error: Verifique algún campo esta vacío', null, 0, 0, 0, 0, []);
            xJSON   = camelcaseKeys(xJSON, {deep: true});
            return apiRES.status(200).json(xJSON);
        })();
...
module.exports  = {
    ...
    getUsuarioFlujoRolSubEmpresa, 
    getUsuarioFlujoRolSupEmpresa,
    getUsuarioFlujoId,
    postUsuarioFlujo,
    putUsuarioFlujo,
    deleteUsuarioFlujo
